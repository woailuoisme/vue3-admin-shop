    ...
    <v-card-text>
      <v-form fast-fail @submit.prevent="submit">
        ...
        <v-text-field
          ...
          label="电话"
        ></v-text-field>
        <v-text-field variant="outlined" clearable v-model="email.value.value"
                      :error-messages="email.errorMessage.value" label="E-mail"></v-text-field>
        <v-select variant="outlined" v-model="select.value.value" :items="items"
        ...
        <v-file-input label="File input" show-size accept="image/png, image/jpeg, image/bmp" variant="outlined"
        ...
        <v-switch v-model="model" :true-value="1" false-value="0" :label="`Switch: ${model.toString()}`" color="info"
