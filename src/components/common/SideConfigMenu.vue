<template>
  <div>
    <v-btn ref="refButton" theme="dark" class="drawer-button" color="#ee44aa" @click="right = true">
      <v-icon class="fa-spin">mdi-cog-outline</v-icon>
    </v-btn>

    <v-navigation-drawer v-model="right" location="right" floating temporary order="-10" width="310">
...
import { ComponentPublicInstance, onMounted, onBeforeUnmount } from "vue"
