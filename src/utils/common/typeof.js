...
is.args = is.arguments = function (value) {
  ...
  const isOldArguments = !is.array(value) && is.arraylike(value) && is.object(value) && is.fn(value.callee)
...
is.file = function (value) {
  return toStr.call(value) === "[object File]"
}
...
is.divisibleBy = function (value, n) {
  ...
  const isNonZeroNumber = is.number(value) && !isActualNaN(value) && is.number(n) && !isActualNaN(n) && n !== 0
