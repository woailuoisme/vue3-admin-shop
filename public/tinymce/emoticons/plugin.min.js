                ...
                var e = 15,
                  r = C.setInterval(function () {
                    a()
                      ...
                      : --e < 0 && (console.log('Could not load emojis from url: ' + o), C.clearInterval(r), n(!1))
                  }, 100)
              })
        },
        listAll: u,
          ...
          u
            ...
            ['catch'](function (t) {
              f.redial({
                ...
                body: {
                  type: 'panel',
                  items: [{ type: 'alertbanner', level: 'error', icon: 'warning', text: '<p>Could not load emoticons</p>' }],
                },
                buttons: [{ type: 'cancel', text: 'Close', primary: !0 }],
  ...
  r.add('emoticons', function (t, n) {
    var e,
      ...
      f =
        ...
        e.getParam('emoticons_database_url', r + '/js/' + o + e.suffix + '.js', 'string')),
